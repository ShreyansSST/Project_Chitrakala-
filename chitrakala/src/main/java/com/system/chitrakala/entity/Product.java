...
public class Product {
    ...
    @Id
    @SequenceGenerator(name = "chitrakala_product_seq_gen", sequenceName = "chitrakala_product_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "chitrakala_product_seq_gen", strategy = GenerationType.SEQUENCE)
    private Integer id;
